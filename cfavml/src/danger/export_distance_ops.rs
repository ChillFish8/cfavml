...
pub mod distance_ops_avx512 {
    ...
    export_distance_op!(
        ...
        register = Avx512,
        op = generic_dot_product,
        xconst = i8_xconst_avx512_nofma_dot,
        xany = i8_xany_avx512_nofma_dot,
        features = "avx512f"
    );
    export_distance_op!(
        description = "Cosine distance of two vectors",
        ...
        register = Avx512,
        op = generic_cosine,
        xconst = i8_xconst_avx512_nofma_cosine,
        xany = i8_xany_avx512_nofma_cosine,
        features = "avx512f"
    );
    export_distance_op!(
        description = "Squared Euclidean distance of two vectors",
        ...
        register = Avx512,
        op = generic_euclidean,
        xconst = i8_xconst_avx512_nofma_squared_euclidean,
        xany = i8_xany_avx512_nofma_squared_euclidean,
        features = "avx512f"
    );
    ...
    export_distance_op!(
        ...
        register = Avx512,
        op = generic_dot_product,
        xconst = i16_xconst_avx512_nofma_dot,
        xany = i16_xany_avx512_nofma_dot,
        features = "avx512f"
    );
    export_distance_op!(
        description = "Cosine distance of two vectors",
        ...
        register = Avx512,
        op = generic_cosine,
        xconst = i16_xconst_avx512_nofma_cosine,
        xany = i16_xany_avx512_nofma_cosine,
        features = "avx512f"
    );
    export_distance_op!(
        description = "Squared Euclidean distance of two vectors",
        ...
        register = Avx512,
        op = generic_euclidean,
        xconst = i16_xconst_avx512_nofma_squared_euclidean,
        xany = i16_xany_avx512_nofma_squared_euclidean,
        features = "avx512f"
    );
    ...
    export_distance_op!(
        ...
        register = Avx512,
        op = generic_dot_product,
        xconst = i32_xconst_avx512_nofma_dot,
        xany = i32_xany_avx512_nofma_dot,
        features = "avx512f"
    );
    export_distance_op!(
        description = "Cosine distance of two vectors",
        ...
        register = Avx512,
        op = generic_cosine,
        xconst = i32_xconst_avx512_nofma_cosine,
        xany = i32_xany_avx512_nofma_cosine,
        features = "avx512f"
    );
    export_distance_op!(
        description = "Squared Euclidean distance of two vectors",
        ...
        register = Avx512,
        op = generic_euclidean,
        xconst = i32_xconst_avx512_nofma_squared_euclidean,
        xany = i32_xany_avx512_nofma_squared_euclidean,
        features = "avx512f"
    );
    ...
    export_distance_op!(
        ...
        register = Avx512,
        op = generic_dot_product,
        xconst = i64_xconst_avx512_nofma_dot,
        xany = i64_xany_avx512_nofma_dot,
        features = "avx512f"
    );
    export_distance_op!(
        description = "Cosine distance of two vectors",
        ...
        register = Avx512,
        op = generic_cosine,
        xconst = i64_xconst_avx512_nofma_cosine,
        xany = i64_xany_avx512_nofma_cosine,
        features = "avx512f"
    );
    export_distance_op!(
        description = "Squared Euclidean distance of two vectors",
        ...
        register = Avx512,
        op = generic_euclidean,
        xconst = i64_xconst_avx512_nofma_squared_euclidean,
        xany = i64_xany_avx512_nofma_squared_euclidean,
        features = "avx512f"
    );
    ...
    export_distance_op!(
        ...
        register = Avx512,
        op = generic_dot_product,
        xconst = u8_xconst_avx512_nofma_dot,
        xany = u8_xany_avx512_nofma_dot,
        features = "avx512f"
    );
    export_distance_op!(
        description = "Cosine distance of two vectors",
        ...
        register = Avx512,
        op = generic_cosine,
        xconst = u8_xconst_avx512_nofma_cosine,
        xany = u8_xany_avx512_nofma_cosine,
        features = "avx512f"
    );
    export_distance_op!(
        description = "Squared Euclidean distance of two vectors",
        ...
        register = Avx512,
        op = generic_euclidean,
        xconst = u8_xconst_avx512_nofma_squared_euclidean,
        xany = u8_xany_avx512_nofma_squared_euclidean,
        features = "avx512f"
    );
    ...
    export_distance_op!(
        ...
        register = Avx512,
        op = generic_dot_product,
        xconst = u16_xconst_avx512_nofma_dot,
        xany = u16_xany_avx512_nofma_dot,
        features = "avx512f"
    );
    export_distance_op!(
        description = "Cosine distance of two vectors",
        ...
        register = Avx512,
        op = generic_cosine,
        xconst = u16_xconst_avx512_nofma_cosine,
        xany = u16_xany_avx512_nofma_cosine,
        features = "avx512f"
    );
    export_distance_op!(
        description = "Squared Euclidean distance of two vectors",
        ...
        register = Avx512,
        op = generic_euclidean,
        xconst = u16_xconst_avx512_nofma_squared_euclidean,
        xany = u16_xany_avx512_nofma_squared_euclidean,
        features = "avx512f"
    );
    ...
    export_distance_op!(
        ...
        register = Avx512,
        op = generic_dot_product,
        xconst = u32_xconst_avx512_nofma_dot,
        xany = u32_xany_avx512_nofma_dot,
        features = "avx512f"
    );
    export_distance_op!(
        description = "Cosine distance of two vectors",
        ...
        register = Avx512,
        op = generic_cosine,
        xconst = u32_xconst_avx512_nofma_cosine,
        xany = u32_xany_avx512_nofma_cosine,
        features = "avx512f"
    );
    export_distance_op!(
        description = "Squared Euclidean distance of two vectors",
        ...
        register = Avx512,
        op = generic_euclidean,
        xconst = u32_xconst_avx512_nofma_squared_euclidean,
        xany = u32_xany_avx512_nofma_squared_euclidean,
        features = "avx512f"
    );
    ...
    export_distance_op!(
        ...
        register = Avx512,
        op = generic_dot_product,
        xconst = u64_xconst_avx512_nofma_dot,
        xany = u64_xany_avx512_nofma_dot,
        features = "avx512f"
    );
    export_distance_op!(
        description = "Cosine distance of two vectors",
        ...
        register = Avx512,
        op = generic_cosine,
        xconst = u64_xconst_avx512_nofma_cosine,
        xany = u64_xany_avx512_nofma_cosine,
        features = "avx512f"
    );
    export_distance_op!(
        description = "Squared Euclidean distance of two vectors",
        ...
        register = Avx512,
        op = generic_euclidean,
        xconst = u64_xconst_avx512_nofma_squared_euclidean,
        xany = u64_xany_avx512_nofma_squared_euclidean,
        features = "avx512f"
    );
    ...
    export_distance_op!(
        ...
        register = Avx512,
        op = generic_dot_product,
        xconst = f32_xconst_avx512_fma_dot,
    ...
    export_distance_op!(
        ...
        register = Avx512,
        op = generic_cosine,
        xconst = f32_xconst_avx512_fma_cosine,
    ...
    export_distance_op!(
        ...
        register = Avx512,
        op = generic_euclidean,
        xconst = f32_xconst_avx512_fma_squared_euclidean,
    ...
    export_distance_op!(
        ...
        register = Avx512,
        op = generic_dot_product,
        xconst = f64_xconst_avx512_fma_dot,
        xany = f64_xany_avx512_fma_dot,
        features = "avx512f"
    );
    export_distance_op!(
        description = "Cosine distance of two vectors",
        ...
        register = Avx512,
        op = generic_cosine,
        xconst = f64_xconst_avx512_fma_cosine,
        xany = f64_xany_avx512_fma_cosine,
        features = "avx512f"
    );
    export_distance_op!(
        description = "Squared Euclidean distance of two vectors",
        ...
        register = Avx512,
        op = generic_euclidean,
        xconst = f64_xconst_avx512_fma_squared_euclidean,
        xany = f64_xany_avx512_fma_squared_euclidean,
        features = "avx512f"
    );
}
...
pub mod distance_ops_neon {
    ...
    export_distance_op!(
        ...
        register = Neon,
        op = generic_dot_product,
        xconst = f32_xconst_neon_fma_dot,
    ...
    export_distance_op!(
        ...
        register = Neon,
        op = generic_cosine,
        xconst = f32_xconst_neon_fma_cosine,
    ...
    export_distance_op!(
        ...
        register = Neon,
        op = generic_euclidean,
        xconst = f32_xconst_neon_fma_squared_euclidean,
    ...
    export_distance_op!(
        ...
        register = Neon,
        op = generic_dot_product,
        xconst = f64_xconst_neon_fma_dot,
        xany = f64_xany_neon_fma_dot,
        features = "neon"
    );
    export_distance_op!(
        description = "Cosine distance of two vectors",
        ...
        register = Neon,
        op = generic_cosine,
        xconst = f64_xconst_neon_fma_cosine,
        xany = f64_xany_neon_fma_cosine,
        features = "neon"
    );
    export_distance_op!(
        description = "Squared Euclidean distance of two vectors",
        ...
        register = Neon,
        op = generic_euclidean,
        xconst = f64_xconst_neon_fma_squared_euclidean,
        xany = f64_xany_neon_fma_squared_euclidean,
        features = "neon"
    );
}
